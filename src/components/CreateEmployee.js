    ...
    return (
        <div className='create'>
            ...
            <form className='create__form' name='form' onSubmit={saveEmployee}>
                ...
                <DatePick htmlFor={"date-of-birth"} label={"Date of Birth"} error={!employee.birthDate && isClick === true ? true : false}  message={'The date of birth field is required'} name={'birthDate'} value={employee.birthDate} isClick={isClick} changeValue={ setEmployee} />
                ...
                <DatePick htmlFor={"start-date"} label={"Start Date"} name={'startDate'} value={employee.startDate} isClick={isClick} changeValue={ setEmployee} />
